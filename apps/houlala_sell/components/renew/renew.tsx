...
import { HoulalaCard, IconImage, RoundedButton, HoulalaButton } from "ui";
    ...
    if (response.status != HttpStatusCode.Ok) {
      switch (response.response.status) {
        case HttpStatusCode.NotFound:
          setErrorMessage(
            "Votre E-mail n'a pas ete retrouve. Svp reessayez plutard. Si" +
