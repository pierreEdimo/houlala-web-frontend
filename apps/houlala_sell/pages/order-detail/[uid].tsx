...
import { HoulalaCard, HoulalaAvatar, Row, HoulalaSpinner } from "ui";
...
const OrderDetail: NextPage = () => {
  ...
  if (error) return <NestedLayout>{error.message}</NestedLayout>;
          ...
          >
            ...
            <div className={styles.verticalInfo}>
              <div className={styles.addressFlex}>
                <b>Ligne d'adresse</b>
                <p>
                  {order?.userInformation.streetName +
                    ", " +
                    order?.userInformation.city}
                </p>
              </div>
              <div className={styles.addressFlex}>
                <b>Rue</b>
